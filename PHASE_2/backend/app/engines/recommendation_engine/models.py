...
class ImpactEstimate:
    ...
    # Forecast-reliability gain: 0-1 normalised improvement in forecast confidence
    # (e.g. REBASELINE_ESTIMATE reduces estimation surprise; APPLY_RAMP_UP_DISCOUNT
    #  corrects capacity forecast).  0.0 for actions unrelated to forecast quality.
    estimated_forecast_confidence_gain: float = 0.0
